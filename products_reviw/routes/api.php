...
Route::group([
    ...
    Route::post('/add-review/{product}',[ReviewController::class,'store']);
    Route::match(['put', 'patch'], '/update-review/{id}',[ReviewController::class,'update']);
    Route::delete( '/delete-review/{id}',[ReviewController::class,'destroy'])->middleware('isadmin');
    Route::get('/all-reviews',[ReviewController::class,'index']);
    Route::get('/show-review',[ReviewController::class,'show']);
    Route::get('/all-user-reviews/{user}',[ReviewController::class,'getAllUserReviews'])->middleware('isadmin');
    Route::get('/all-product-reviews/{product}',[ReviewController::class,'getAllProductReviews']);
